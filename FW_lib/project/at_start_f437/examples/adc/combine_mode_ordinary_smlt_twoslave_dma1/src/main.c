...
/** @addtogroup 437_ADC_combine_mode_ordinary_smlt_twoslave_dma1 ADC_combine_mode_ordinary_smlt_twoslave_dma1
  * @{
  */

__IO uint16_t adccom_ordinary_valuetab[3][3][3];
...
static void adc_config(void)
{
  ...
  adc_ordinary_conversion_trigger_set(ADC1, ADC_ORDINARY_TRIG_TMR1TRGOUT2, ADC_ORDINARY_TRIG_EDGE_RISING);
...
int main(void)
{
  ...
  else
  {
    ...
    for(index1 = 0; index1 < 3; index1++)
    {
      ...
      {
        printf("adccom_ordinary_valuetab[%d][%d][0] = 0x%x\r\n",index1, index2, adccom_ordinary_valuetab[index1][index2][0]);
        printf("adccom_ordinary_valuetab[%d][%d][1] = 0x%x\r\n",index1, index2, adccom_ordinary_valuetab[index1][index2][1]);
        printf("adccom_ordinary_valuetab[%d][%d][2] = 0x%x\r\n",index1, index2, adccom_ordinary_valuetab[index1][index2][2]);
      }
      printf("\r\n");
    }
  }
