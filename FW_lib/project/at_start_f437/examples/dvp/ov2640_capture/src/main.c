...
/** @addtogroup 437_DVP_ov2640_capture DVP_ov2640_capture
  * @{
  */
...
int main(void)
{
  ...
  lcd_string_show(30, 70, 200, 16, 16, (uint8_t *)"OV2640 TEST");
  lcd_string_show(30, 90, 200, 16, 16, (uint8_t *)"2021/6/21");

  delay_ms(500);
  while(ov2640_init() != SUCCESS)
  {
    lcd_string_show(30, 130, 240, 16, 16, (uint8_t *)"OV2640 ERR");
    delay_ms(200);
  ...
  lcd_string_show(30, 130, 200, 16, 16, (uint8_t *)"OV2640 OK");
...
void ov2640_capture(void)
{
  ...
  lcd_string_show(30, 50, 200, 16, 16, (uint8_t *)"Artery AT32F435/F437");
  lcd_string_show(30, 70, 200, 16, 16, (uint8_t *)"OV2640 RGB565 Mode");
