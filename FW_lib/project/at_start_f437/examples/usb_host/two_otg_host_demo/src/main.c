...
/** @addtogroup 437_USB_host_two_otg_host_demo USB_host_two_otg_host_demo
  * @{
  */
...
#ifdef USBH_5V_POWER_SWITCH
  crm_periph_clock_enable(OTG2_PIN_POWER_SWITCH_CLOCK, TRUE);
  gpio_bits_set(OTG2_PIN_POWER_SWITCH_GPIO, OTG2_PIN_POWER_SWITCH);

  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_STRONGER;
  gpio_init_struct.gpio_out_type  = GPIO_OUTPUT_OPEN_DRAIN;
  gpio_init_struct.gpio_mode = GPIO_MODE_OUTPUT;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init_struct.gpio_pins = OTG2_PIN_POWER_SWITCH;
  gpio_init(OTG2_PIN_POWER_SWITCH_GPIO, &gpio_init_struct);
#endif
