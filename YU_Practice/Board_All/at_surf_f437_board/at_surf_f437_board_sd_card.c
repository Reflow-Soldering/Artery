...
sd_error_status_type sd_init(void)
{
  ...
  crm_periph_clock_enable(SDIO_D0_GPIO_CLK, TRUE);
  crm_periph_clock_enable(SDIO_D1_GPIO_CLK, TRUE);
  crm_periph_clock_enable(SDIO_D2_GPIO_CLK, TRUE);
  crm_periph_clock_enable(SDIO_D3_GPIO_CLK, TRUE);
  crm_periph_clock_enable(SDIO_CMD_GPIO_CLK, TRUE);
  crm_periph_clock_enable(SDIO_CLK_GPIO_CLK, TRUE);

  /* sdio periph clock enable */
  crm_periph_clock_enable(SDIO_PERIPH_CLK, TRUE);

  /* configure d0, d1, d2, d3, clk pin */
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_STRONGER;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;

  gpio_init_struct.gpio_pins = SDIO_D0_GPIO_PIN;
  gpio_init(SDIO_D0_GPIO_PORT, &gpio_init_struct);

  gpio_init_struct.gpio_pins = SDIO_D1_GPIO_PIN;
  gpio_init(SDIO_D1_GPIO_PORT, &gpio_init_struct);

  gpio_init_struct.gpio_pins = SDIO_D2_GPIO_PIN;
  gpio_init(SDIO_D2_GPIO_PORT, &gpio_init_struct);

  gpio_init_struct.gpio_pins = SDIO_D3_GPIO_PIN;
  gpio_init(SDIO_D3_GPIO_PORT, &gpio_init_struct);

  gpio_init_struct.gpio_pins = SDIO_CMD_GPIO_PIN;
  gpio_init(SDIO_CMD_GPIO_PORT, &gpio_init_struct);

  gpio_init_struct.gpio_pins = SDIO_CLK_GPIO_PIN;
  gpio_init(SDIO_CLK_GPIO_PORT, &gpio_init_struct);

  /* configure pin mux */
  gpio_pin_mux_config(SDIO_D0_GPIO_PORT,  SDIO_D0_GPIO_PINS_SOURCE,  SDIO_D0_GPIO_MUX);
  gpio_pin_mux_config(SDIO_D1_GPIO_PORT,  SDIO_D1_GPIO_PINS_SOURCE,  SDIO_D1_GPIO_MUX);
  gpio_pin_mux_config(SDIO_D2_GPIO_PORT,  SDIO_D2_GPIO_PINS_SOURCE,  SDIO_D2_GPIO_MUX);
  gpio_pin_mux_config(SDIO_D3_GPIO_PORT,  SDIO_D3_GPIO_PINS_SOURCE,  SDIO_D3_GPIO_MUX);
  gpio_pin_mux_config(SDIO_CMD_GPIO_PORT, SDIO_CMD_GPIO_PINS_SOURCE, SDIO_CMD_GPIO_MUX);
  gpio_pin_mux_config(SDIO_CLK_GPIO_PORT, SDIO_CLK_GPIO_PINS_SOURCE, SDIO_CLK_GPIO_MUX);

  nvic_irq_enable(SDIOx_IRQn, 1, 0);
