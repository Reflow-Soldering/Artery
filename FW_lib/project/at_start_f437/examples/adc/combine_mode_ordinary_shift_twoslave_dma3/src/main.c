...
/** @addtogroup 437_ADC_combine_mode_ordinary_shift_twoslave_dma3 ADC_combine_mode_ordinary_shift_twoslave_dma3
  * @{
  */

__IO uint16_t adccom_ordinary_valuetab[6];
...
int main(void)
{
  ...
  dma_config();
  adc_config();
  printf("combine_mode_ordinary_shift_twoslave_dma3 \r\n");
