...
/** @addtogroup 437_XMC_sdram_basic XMC_sdram_basic
  * @{
  */
...
int main(void)
{
  ...
  sdram_writebuffer(txbuffer, write_read_addr, buffer_size);

  /* read data from xmc sdram memory */
  sdram_readbuffer(rxbuffer, write_read_addr, buffer_size);
