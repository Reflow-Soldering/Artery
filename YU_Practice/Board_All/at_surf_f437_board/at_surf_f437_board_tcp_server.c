...
static err_t tcp_server_recv(void *arg, struct tcp_pcb *pcb,struct pbuf *p,err_t err)
{
  ...
  if(p != NULL)
  {
    pPrintBuf = (char*)malloc(p->tot_len * sizeof(char) + 1);
    memset(pPrintBuf, 0, p->tot_len * sizeof(char) + 1);
    ...
    lcd_fill(10, 250, 300, 280, BLACK);

    lcd_string_show(10, 220, 300, 24, 24, (uint8_t *)"receive data:");

    lcd_string_show(10, 250, 300, 24, 24, (uint8_t *)pPrintBuf);
  }
  else
  {
