...
/** @addtogroup 437_TMR_complementary_signals TMR_complementary_signals
  * @{
  */
...
int main(void)
{
  ...
  1/ generate 3 complementary pwm signals with 3 different duty cycles:
    tmr1clk is fixed to apb2_freq*2, the tmr1 prescaler is equal to 0 so the
    tmr1 counter clock used is apb2_freq*2.
