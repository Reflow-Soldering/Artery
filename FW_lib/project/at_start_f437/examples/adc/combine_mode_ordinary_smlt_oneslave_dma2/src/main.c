...
/** @addtogroup 437_ADC_combine_mode_ordinary_smlt_oneslave_dma2 ADC_combine_mode_ordinary_smlt_oneslave_dma2
  * @{
  */
...
int main(void)
{
  ...
  dma_config();
  adc_config();
  printf("combine_mode_ordinary_smlt_oneslave_dma2 \r\n");
